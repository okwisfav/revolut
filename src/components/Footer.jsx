    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
            ...
            <div>
                ...
                <ul className='py-6 text-[#6D737A]'>
                    <li className='py-2'>Help & Security</li>
                    <li className='py-2'>Information Security</li>
                    <li className='py-2'>Bank Safely</li>
                    <li className='py-2'>Shop Safely Online</li>
                    <li className='py-2'>Business Continuity Policy</li>
                    <li className='py-2'>Service Management Policy</li>
                    <li className='py-2'>Payment</li>
            ...
            <div className='max-[780px]:col-span-2'>
                ...
                <h3 className='py-2 text-[#6D737A]'>Subscribe for more new </h3>
                <form className='py-4'>
                    <input 
